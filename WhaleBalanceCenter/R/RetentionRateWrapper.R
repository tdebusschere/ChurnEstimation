...
ConnectToDB = function(db)
{
  ...
  db_password <- kd$get(DB_Settings[[db]], db_user)
  con <- odbcDriverConnect(paste0('driver={ODBC DRIVER 17 FOR SQL Server};server=10.80.29.155\\MSSQLSERVER2016;uid=', 
...
parsed_opts$site     <- 'DQ002'
parsed_opts$activity <- '2020-02-25'
parsed_opts$version  <- ''
